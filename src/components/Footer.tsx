  ...
  return (
    ...
    >
      ...
      >
        <Flex direction={['column', 'row']} justifyContent="space-between">
          <Box>
            <Text fontSize={['xs', 'sm']} fontWeight="bold">
              INSTITUT KRISTEN BUKIT PENGHARAPAN
            </Text>
            <Text fontSize={['xx-small', 'xs']}>
              Kalisoro - Tawangmangu, Karanganyar, Jawa Tengah.
            </Text>
            <Text fontSize={['xx-small', 'xs']}>Indonesia 57792.</Text>
            <Text fontSize={['xx-small', 'xs']}>
              Telp. 081246953030 | info@bukitpengharapan.ac.id
            </Text>
          </Box>
        ...
        <Text marginTop="10" alignSelf="center" fontSize={['xx-small', 'xs']}>
          &copy; 2021 INSTITUT KRISTEN BUKIT PENGHARAPAN
        </Text>
      </Flex>
    </chakra.footer>
  )
